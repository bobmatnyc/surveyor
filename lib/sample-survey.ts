...
export const sampleSurveySchema: SurveySchema = {
  ...
  questions: [
    ...
    {
      id: 'data_collection_ceo',
      text: 'How confident are you in your organization\'s ability to collect and analyze data for decision making?',
      type: 'likert_5' as any,
      domain: 'data',
      targetStakeholders: ['ceo'],
      required: true,
      options: [
        { value: 1, label: 'Not confident - data collection is ad-hoc and unreliable' },
        { value: 2, label: 'Somewhat confident - basic data collection but limited analysis' },
        { value: 3, label: 'Moderately confident - regular data collection with some analysis' },
        { value: 4, label: 'Confident - systematic data collection with regular analysis' },
        { value: 5, label: 'Very confident - comprehensive data-driven decision making' }
      ]
    },
    {
      id: 'data_systems_tech',
      text: 'How would you rate your organization\'s data integration and management systems?',
      type: 'likert_5' as any,
      domain: 'data',
      targetStakeholders: ['tech_lead'],
      required: true,
      options: [
        { value: 1, label: 'No integration - data exists in silos' },
        { value: 2, label: 'Basic integration between some systems' },
        { value: 3, label: 'Moderate integration with manual processes' },
        { value: 4, label: 'Good integration with automated data flows' },
        { value: 5, label: 'Excellent integration with real-time data synchronization' }
      ]
    },
    {
      id: 'business_systems_ceo',
      text: 'How effectively do your business systems (HR, Finance, CRM) support your operations?',
      type: 'likert_5' as any,
      domain: 'business_systems',
      targetStakeholders: ['ceo'],
      required: true,
      options: [
        { value: 1, label: 'Not effective - systems create significant barriers' },
        { value: 2, label: 'Somewhat effective - systems work but require workarounds' },
        { value: 3, label: 'Moderately effective - systems meet basic needs' },
        { value: 4, label: 'Effective - systems enhance productivity' },
        { value: 5, label: 'Very effective - systems are strategic enablers' }
      ]
    },
    {
      id: 'program_tech_staff',
      text: 'How well does technology support your daily program delivery work?',
      type: 'likert_5' as any,
      domain: 'program_tech',
      targetStakeholders: ['staff'],
      required: true,
      options: [
        { value: 1, label: 'Not well - technology hinders my work' },
        { value: 2, label: 'Somewhat well - technology has limited usefulness' },
        { value: 3, label: 'Moderately well - technology helps with basic tasks' },
        { value: 4, label: 'Well - technology enhances my effectiveness' },
        { value: 5, label: 'Very well - technology is essential to my success' }
      ]
    },
    {
      id: 'culture_leadership_ceo',
      text: 'How would you rate your organization\'s leadership commitment to technology advancement?',
      type: 'likert_5' as any,
      domain: 'culture',
      targetStakeholders: ['ceo'],
      required: true,
      options: [
        { value: 1, label: 'Low commitment - technology is not a priority' },
        { value: 2, label: 'Some commitment - technology is addressed when problems arise' },
        { value: 3, label: 'Moderate commitment - technology is included in planning' },
        { value: 4, label: 'High commitment - technology is a strategic priority' },
        { value: 5, label: 'Very high commitment - technology drives organizational strategy' }
      ]
    },
    {
      id: 'culture_board_oversight',
      text: 'How engaged is the board in technology governance and oversight?',
      type: 'likert_5' as any,
      domain: 'culture',
      targetStakeholders: ['board'],
      required: true,
      options: [
        { value: 1, label: 'Not engaged - board rarely discusses technology' },
        { value: 2, label: 'Minimally engaged - board discusses technology when issues arise' },
        { value: 3, label: 'Moderately engaged - board receives regular technology updates' },
        { value: 4, label: 'Engaged - board actively participates in technology planning' },
        { value: 5, label: 'Highly engaged - board provides strategic technology leadership' }
      ]
    }
  ],
  scoring: {
